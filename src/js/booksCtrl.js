...
angular.module('App').controller('booksCtrl', ['$scope','$http','$state', '$localStorage', function ($scope, $http, $state, $localStorage) {
    ...
    $scope.getBooks = function () {
        ...
        $http({
            method: 'POST',
            url: 'http://multimedia.uoc.edu/frontend/getbooks.php?page='+$scope.page
