...
angular.module('App').controller('orderCtrl', ['$scope','$http','$state','$localStorage', function ($scope, $http, $state, $localStorage) {
    ...
    $scope.createObject = function (data) {
        ...
        bookObject = {
            "id":$scope.id, "imagen": $scope.imagen, "titulo": $scope.titulo, "precio": $scope.precio, "cantidad": cantidad, "precioTotal": $scope.precioTotal
        };
